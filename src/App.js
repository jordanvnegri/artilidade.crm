      ...
      <div style={{ padding: "22px 20px 14px", borderBottom: "1px solid #2D3A4E" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: 8, overflow: "hidden", flexShrink: 0 }}>
            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==" alt="Artilidade" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#1E2A3B 0%,#2563EB 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Inter,system-ui,sans-serif" }}>
      <div style={{ width: "100%", maxWidth: 400, padding: "0 20px" }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div style={{ width: 60, height: 60, borderRadius: 16, background: "#fff", margin: "0 auto 14px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28 }}>⚡</div>
    ...
    <div>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 8 }}>
            {[["Nome *","name"],["Empresa *","company"],["E-mail","email"],["Telefone","phone"],["Responsavel","responsible"]].map(function(f) {
              return <input key={f[1]} value={nf[f[1]]} onChange={function(e) { setNF(f[1], e.target.value); }} placeholder={f[0]}
                style={{ flex: "1 1 160px", padding: "8px 10px", border: "1px solid " + C.primaryMid, borderRadius: 7, fontSize: 13, outline: "none" }} />;
            })}
          </div>
          <div style={{ display: "flex", gap: 8 }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 12, margin: "20px 0" }}>
        {[
          ...
          return (
            <div key={m.label} style={{ background: C.surface, border: "1px solid " + C.border, borderRadius: 12, padding: "14px 18px", display: "flex", alignItems: "center", gap: 12, flex: "1 1 160px" }}>
...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", fontFamily: "Inter,system-ui,sans-serif", background: C.bg, minHeight: "100vh" }}>
      <Sidebar user={currentUser} active={activeNav} onNav={nav} onLogout={logout} />
      <main style={{ flex: 1, padding: "28px 28px", overflowY: "auto" }}>{renderContent()}</main>
    </div>
  );
}
